...
public class KeyguardUpdateMonitor implements TrustManager.TrustListener {
            ...
            if (Intent.ACTION_TIME_TICK.equals(action)
                ...
                final Message msg = mHandler.obtainMessage(
                        MSG_BATTERY_UPDATE, new BatteryStatus(status, level, plugged, health,
                                dashChargeStatus, maxChargingMicroAmp, maxChargingMicroVolt, maxChargingMicroWatt,
				temperature));
    ...
    public static class BatteryStatus {
        ...
        public BatteryStatus(int status, int level, int plugged, int health,
                boolean dashChargeStatus, int maxChargingCurrent, int maxChargingVoltage, int maxChargingWattage,
                int temperature) {
            this.status = status;
            this.level = level;
    ...
    private KeyguardUpdateMonitor(Context context) {
        ...
        mBatteryStatus = new BatteryStatus(BATTERY_STATUS_UNKNOWN, 100, 0, 0, false, 0 , 0 , 0, 0);
